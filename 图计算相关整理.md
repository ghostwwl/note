...
- https://spark-packages.org/package/graphframes/graphframes
    - graphframes-0.8.0-spark3.0-s_2.12.jar
...
- [OLAP]
OLAP（On-Line Analytical Processing）联机分析处理的概念最早是由关系数据库之父E.F.Codd于1993年提出的，他同时提出了关于OLAP的12条准则。  
...
- spark2.2以上可以 看看 google的 Pregel
- 安装neo4j-spark-connect
...
- 具体安装操作： https://www.jianshu.com/p/35d64ae3d893
- 测试用例
    - 具体可以看：https://github.com/neo4j-contrib/neo4j-spark-connector

- [http://blog.nsfocus.net/graph-mining/](http://blog.nsfocus.net/graph-mining/)